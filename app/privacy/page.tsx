...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    // Insert the privacy policy content
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <HeroSection
        title={t('privacy.hero.title') || "Privacy Policy"}
        description={t('privacy.hero.description') || "Our commitment to protecting your privacy and personal information"}
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          <div id="privacy-policy-container" className="prose max-w-none dark:prose-invert">
            {/* Privacy policy content will be inserted here by useEffect */}
          </div>
        </div>
      </div>
    </div>
